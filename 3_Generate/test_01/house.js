class House{
    ...
    renderWalls(){
        ...
        vertex(this.depth, -this.height/2);
        vertex(this.depth, this.height/2);
        vertex(0, this.height/2);
        // door
        ...
        let windowH = 0;
        let windowX = 0;
        //rect((this.depth - this.deltaDepth)/2, windowX, windowH, windowW);
        pop();
        //WEST
        push();
        translate(-this.width/2,0);
        ...
        beginShape();
        vertex(0, -this.height/2);
        vertex(this.depth - this.deltaDepth, -this.height/2);
        vertex(this.depth - this.deltaDepth, this.height/2);
        vertex(0, this.height/2);
        endShape(CLOSE);
        windowW = map(this.windowCoverage,0,1,0,this.height * 0.9);
        windowH = (this.depth - this.deltaDepth) * .8;
        windowX = 0;
        rect((this.depth - this.deltaDepth)/2, windowX, windowH, windowW);
        pop();
        //NORTH
        ...
        vertex(-this.width/2,-(this.depth-this.deltaDepth));
        vertex(this.width/2,-(this.depth));
        vertex(this.width/2,0);
        endShape(CLOSE);
        windowW = map(this.windowCoverage,0,1,0,this.width * 0.9);
        windowH = (this.depth - this.deltaDepth) * .8;
        windowX = 0;
        rect(windowX,-(this.depth - this.deltaDepth)/2,windowW, windowH);
        pop();
        //SOUTH
         push();
         translate(0,this.height/2);

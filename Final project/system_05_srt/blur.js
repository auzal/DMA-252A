class Blur{
    ...
    apply(originalTexture){
        let minVertical = ((1.0/height) * CONFIG.maxBlurScale) * 0.05;
        let minHorizontal = ((1.0/width)*  CONFIG.maxBlurScale) * 0.05;
        let texelVertical = map(this.blurAmount, 0, 1, minVertical, (1.0/height) * CONFIG.maxBlurScale);
        let texelHorizontal = map(this.blurAmount, 0, 1, minHorizontal, (1.0/width)*  CONFIG.maxBlurScale);

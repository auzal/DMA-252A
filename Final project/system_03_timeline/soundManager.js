class SoundManager{
    ...
    update(control){
        ...
        let reverbNoise = noise(frameCount*0.05);
        this.reverbWetDry = map(reverbNoise, 0, 1, 0.4, 0.9) * control;
      ...
      //  this.reverb.drywet(0);
        ...
        let frequencyNoise = noise(0,frameCount*0.005);
        this.filterFrequency = map(frequencyNoise, 0, 1, this.minFrequency, this.maxFrequency/8);
        this.filterFrequency = constrain(this.filterFrequency, 0, 22050);
        this.filter.freq(this.filterFrequency);
        //  give the filter a narrow band (lower res = wider bandpass)
        this.filterResonance = map(control, 0, 1, this.minResonance, this.maxResonance/3);

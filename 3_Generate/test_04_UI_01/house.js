class House{
    ...
    randomize(){
        ...
        this.depth = random(120,350);
        this.roofAngle = (random(0,18));
    ...
    calculate(){
        this.deltaDepth = tan(radians(this.roofAngle)) * this.width;
    ...
    renderRoof(){
        ...
        rotateY(radians(-this.roofAngle));
    ...
    update(){
        ...
        if(widthSlider.value != this.height ||
        heightSlider.value != this.depth ||
        depthSlider.value != this.width){
            this.width = depthSlider.value;
            this.height = widthSlider.value;
            this.depth = heightSlider.value;
            this.calculate();
        }

        if(this.windowCoverage != windowSlider.value/100.0){
            this.windowCoverage =windowSlider.value/100;
            windowSlider.value = this.windowCoverage * 100;
            this.calculate();
        }

        if(this.roofAngle != roofSlider.value){
            this.roofAngle = roofSlider.value;
            //windowSlider.value = this.windowCoverage * 100;
            this.calculate();
        }

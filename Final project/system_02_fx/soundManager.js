class SoundManager{
    ...
    update(){
        ...
        this.reverbWetDry = constrain(map(mouseY, 0, height, 0, 1), 0, 1);
        ...
        this.filterFrequency = map(mouseX, 0, width, this.minFrequency, this.maxFrequency);
        this.filterFrequency = constrain(this.filterFrequency, 0, 22050);
        this.filter.freq(this.filterFrequency);
        //  give the filter a narrow band (lower res = wider bandpass)
        this.filterResonance = map(mouseY, 0, height, this.minResonance, this.maxResonance);
